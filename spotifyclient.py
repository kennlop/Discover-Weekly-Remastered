...
class SpotifyClient:
    ...
    def getUserDiscoverWeekly(self):
        """Get the songs from User's Discover Weekly Playlist

        :return tracks (list of Track): List of last played tracks
        """
        #YOU CAN CHANGE THIS URL TO ANY IN YOUR LIBRARY TO PULL FROM OTHER PLAYLISTS
        url = "https://api.spotify.com/v1/playlists/37i9dQZEVXcQIqzOuVdbZa/tracks?fields=items(track%2C%20album)"
    ...
    #Here you can change the length of the playlist by changing the :param limit
    def get_track_recommendations(self, seed_tracks, limit=30):
        ...
        #URL for creating the playlist using seed tracks and the :param limit
    ...
    def create_playlist(self, name):
        ...
        data = json.dumps({
            "name": name,
            "description": "Recommended songs generated using Discover Weekly REMASTERED",
            "public": True
        })
        url = "https://api.spotify.com/v1/users/kenbropez/playlists"
